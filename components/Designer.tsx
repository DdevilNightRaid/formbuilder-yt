...
function DesignerElementWrapper({ element }: { element: FormElementInstance }) {
    ...
    // hover preview:
    const [mosueIsOver, setMouseIsOver] = useState<boolean>(false);
    ...
    return (
        <div
            ...
            className="relative h-[120px] flex flex-col text-foregorund hover:cursor-pointer rounded-md ring-1 ring-accent ring-inset"
        ...
        >
                ...
                mosueIsOver && (
                    <>
                        ...
                        <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 animate-pulse">
                            <p className="text-muted-foreground text-sm">Click for propertes or drag to move</p>
                        </div>
                    </>
                )
            }
            ...
            <div
                className={cn("flex w-full h-[120px] items-center bg-accent/40 rounded-md px-4 py-2 pointer-events-none opacity-100",
                    mosueIsOver && "opacity-30",
                )}
            >
